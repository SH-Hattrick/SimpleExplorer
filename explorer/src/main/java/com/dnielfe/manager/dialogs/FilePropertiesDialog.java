...
public final class FilePropertiesDialog extends DialogFragment {
    ...
    private static final class FilePropertiesPagerItem implements PagerItem {
        private final File mFile;
        private TextView mPathLabel, mTimeLabel, mSizeLabel, mMD5Label, mSHA1Label, filecountlabel, dircountlabel, writeable;
        private View mView;
        ...
        private void initView(View table) {
            ...
            this.filecountlabel = (TextView) table.findViewById(R.id.file_count);
            this.dircountlabel = (TextView) table.findViewById(R.id.directory_count);
            this.writeable = (TextView) table.findViewById(R.id.writeable);
        }
        ...
        private final class LoadFsTask extends AsyncTask<File, Void, String[]> {
            ...
            protected String[] doInBackground(final File... params) {
                ...
                String md5, sha1, size, filecount, dircount, writeable = mFile.canWrite() ? "yes" : "no";;
                int fc = 0,dc = 0;
                ...
                if (params[0].isFile()) {
                    ...
                    filecount = ((Integer)fc).toString();
                    dircount = ((Integer)dc).toString();
                }

                return new String[]{size, time, md5, sha1, filecount, dircount, writeable};
            }
